...
from fake_stake.base_test import ReiBit_FakeStakeTest

class zRITwrappedSerialsTest(ReiBit_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zRITs..." % DENOM_TO_USE)
