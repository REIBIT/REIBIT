                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRITPathCustom = GetArg("-zritbackuppath", "");
    ...
    if(!strzRITPathCustom.empty()) {
        ui->wallet_customzritbackuppath->setText(QString::fromStdString(strzRITPathCustom));
        ui->wallet_customzritbackuppath_label->setVisible(true);
        ui->wallet_customzritbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRITPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ReiBit RPC console.") + "<br>" +
