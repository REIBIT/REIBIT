...
/** Utility functions used by the ReiBit Qt UI.
 */
namespace GUIUtil
{
...
// Render ReiBit addresses in monospace font
...
// Parse "reibit:" URI into recipient object, return true on successful parsing
