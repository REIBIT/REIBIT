...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::RIT);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeReiBitAmount"))
        SoftSetArg("-anonymizereibitamount", settings.value("nAnonymizeReiBitAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in reibit.cpp during shotdown to also remove the window positions
