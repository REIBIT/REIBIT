...
/* ReiBit GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ReiBit"
#define QAPP_ORG_DOMAIN "reibit.org"
#define QAPP_APP_NAME_DEFAULT "ReiBit-Qt"
#define QAPP_APP_NAME_TESTNET "ReiBit-Qt-testnet"
