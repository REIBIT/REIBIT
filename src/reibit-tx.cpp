...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ReiBit Core reibit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  reibit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded reibit transaction") + "\n" +
                               "  reibit-tx [options] -create [commands]   " + _("Create hex-encoded reibit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded reibit transaction
