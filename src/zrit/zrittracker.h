...
#ifndef ReiBit_ZRITTRACKER_H
#define ReiBit_ZRITTRACKER_H
...
public:
    CzRITTracker(std::string strWalletFile);
    ~CzRITTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRITWallet* zRITWallet = NULL);
