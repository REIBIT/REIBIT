...
#ifndef ReiBit_ZRITWALLET_H
#define ReiBit_ZRITWALLET_H
...
public:
    CzRITWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRIT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRIT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
