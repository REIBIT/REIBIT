...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ReiBit features */
        {"reibit", "listmasternodes", &listmasternodes, true, true, false},
        {"reibit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"reibit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"reibit", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"reibit", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"reibit", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"reibit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"reibit", "masternodedebug", &masternodedebug, true, true, false},
        {"reibit", "startmasternode", &startmasternode, true, true, false},
        {"reibit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"reibit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"reibit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"reibit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"reibit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"reibit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"reibit", "preparebudget", &preparebudget, true, true, false},
        {"reibit", "submitbudget", &submitbudget, true, true, false},
        {"reibit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"reibit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"reibit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"reibit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"reibit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"reibit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"reibit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"reibit", "checkbudgets", &checkbudgets, true, true, false},
        {"reibit", "mnsync", &mnsync, true, true, false},
        {"reibit", "spork", &spork, true, true, false},
        {"reibit", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzritseed", &getzritseed, false, false, true},
        {"zerocoin", "setzritseed", &setzritseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzrit", &searchdzrit, false, false, true},
        {"zerocoin", "dzritstate", &dzritstate, false, false, true},
...
{
    return "> reibit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33427/\n";
}
