...
extern UniValue DoZritSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzritseed(const UniValue& params, bool fHelp);
extern UniValue getzritseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzrit(const UniValue& params, bool fHelp);
extern UniValue dzritstate(const UniValue& params, bool fHelp);
