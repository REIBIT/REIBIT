...
This document provides guidelines for internationalization of the ReiBit Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to ReiBit network</numerusform>
            <numerusform>%n active connections to ReiBit network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `reibit_en.ts` remains unchanged.
