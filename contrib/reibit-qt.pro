...
RESOURCES += src/qt/reibit.qrc src/qt/reibit_locale.qrc

TRANSLATIONS += src/qt/locale/reibit_bg.ts \
                src/qt/locale/reibit_de.ts \
                src/qt/locale/reibit_en.ts \
                src/qt/locale/reibit_es.ts \
                src/qt/locale/reibit_fi.ts \
                src/qt/locale/reibit_fr.ts \
                src/qt/locale/reibit_it.ts \
                src/qt/locale/reibit_ja.ts \
                src/qt/locale/reibit_pl.ts \
                src/qt/locale/reibit_pt.ts \
                src/qt/locale/reibit_ru.ts \
                src/qt/locale/reibit_sk.ts \
                src/qt/locale/reibit_sv.ts \
                src/qt/locale/reibit_vi.ts \
                src/qt/locale/reibit_zh_CN.ts \
                src/qt/locale/reibit_zh_TW.ts
