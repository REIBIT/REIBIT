Contributing to ReiBit Core
============================

The ReiBit Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/reibit-project/reibit/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ReiBit Core project, and is not to be
confused with overall ReiBit Network Protocol consensus changes.

Whether a pull request is merged into ReiBit Core rests with the project merge
...
Patches that change ReiBit consensus rules are considerably more involved than
...
Where a patchset proposes to change the ReiBit consensus, it must have been
...
The project leader is the release manager for each ReiBit Core release.
